...
const BUILDING_ASSETS: readonly BuildingAssetDefinition[] = [
  ...
  // Capela gárgula: modelo da Cripta (base do Vampiro).
  { kind: 'crypt', src: 'assets/buildings/crypt.glb' },
  ...
  // Muro: faixas 1-5, 6-10 e 11, sempre com escala uniforme.
  { kind: 'wall', src: 'assets/buildings/wall.glb' },
  { kind: 'wall', src: 'assets/buildings/wall_1_2_3_4_5.glb', minLevel: 1, maxLevel: 5 },
  { kind: 'wall', src: 'assets/buildings/wall_6_7_8_9_10.glb', minLevel: 6, maxLevel: 10 },
  { kind: 'wall', src: 'assets/buildings/wall_11.glb', minLevel: 11, maxLevel: 11 },
